...
public class TransactionController implements Initializable {
    ...
    @FXML
    private JFXButton btnViewTransactions;
    @FXML
    ...
    private void btnDashboardAction(ActionEvent event) {
        setCenter("/aloe/view/pharmacist/transaction/dashboard.fxml");
    }
    
    @FXML
    private void btnViewTransactionsAction(ActionEvent event) {
        setCenter("/aloe/view/pharmacist/transaction/viewTransactions.fxml");
    }
  
    @FXML
    private void btnSalesAction(ActionEvent event) {
        setCenter("/aloe/view/pharmacist/transaction/viewSales.fxml"); 
    }
    ...
    private void btnStockAction(ActionEvent event) {
         PopWindow window = new PopWindow();
         loc.push("/aloe/view/pharmacist/transaction.fxml");
        if(PopWindow.primaryStage.isMaximized()){
