...
import static aloe.controller.receptionist.transaction.ViewSalesController.salesList;
...
public class ViewSalesController implements Initializable {
    ...
    @FXML
    private TableColumn<Sale, String> soldByCol;
    @FXML
    private TableColumn<Sale, String> drugNameCol;
    @FXML
    private TableColumn<Sale, String> quantityCol;
    @FXML
    ...
    private void initCols(){
        ...
        soldByCol.setCellValueFactory(new PropertyValueFactory<>("username"));
        ...
        try {
            ...
            while(rs1.next()){
              ...
              if(rs2.next()){
                  ...
                  String soldBy =rs2.getString("trans_by");
                  ...
                  if(rs3.next()){
                      ...
                      if(rs4.next()){
                           ...
                           salesList.add( new Sale(saleNo,soldBy,name,quantity,charge,transDate));
                      }
                  }else{
            ...
            Logger.getLogger(aloe.controller.receptionist.transaction.ViewSalesController.class.getName()).log(Level.SEVERE, null, ex);
        }
          ...
          FilteredList <Sale> filteredList = new FilteredList<>(salesList,p->true);  //wrap all drugs in filtered List 
            txtSearch.textProperty().addListener((ObservableValue,oldValue,newValue)->{
                  filteredList.setPredicate((Predicate<? super Sale>) sale ->{  //set predicate when the text in the search field changes
                    ...
                    if (sale.getUsername().toLowerCase().contains(filterLowerCase)){
                        return true;
                    }
