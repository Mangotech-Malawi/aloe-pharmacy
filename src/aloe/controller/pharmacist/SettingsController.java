...
public class SettingsController implements Initializable {
    ...
    private void btnStockAction(ActionEvent event) {
         PopWindow window = new PopWindow();
         loc.push("/aloe/view/pharmacist/settings.fxml");
        if(PopWindow.primaryStage.isMaximized()){
    ...
    private void btnExpensesAction(ActionEvent event) {
         ...
         loc.push("/aloe/view/pharmacist/settings.fxml");
        if(PopWindow.primaryStage.isMaximized()){
              window.loadWindow("/aloe/view/pharmacist/expenses.fxml", "Pharmacy System : Reports",true,true,false,false);
        }else{
              window.loadWindow("/aloe/view/pharmacist/expenses.fxml", "Pharmacy System : Reports",true,false,false,false);
        }
    ...
    private void btnReportsAction(ActionEvent event) {
         ...
         loc.push("/aloe/view/pharmacist/settings.fxml");
        if(PopWindow.primaryStage.isMaximized()){
              window.loadWindow("/aloe/view/pharmacist/reports.fxml", "Pharmacy System : Reports",true,true,false,false);
        }else{
              window.loadWindow("/aloe/view/pharmacist/reports.fxml", "Pharmacy System : Reports",true,false,false,false);
        }
