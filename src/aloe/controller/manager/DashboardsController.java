 ...
 * @author Senze
 */
public class DashboardsController extends Thread implements Initializable  {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        if(PopWindow.primaryStage.isMaximized()){
         ...
         setCenter("/aloe/view/manager/dashboards/master.fxml");
    }    
    ...
    private void btnCloseAction(ActionEvent event) {
         ...
         userLog.updateActivities(logInDate,", Exited in Manager Dashboards");
    ...
    @FXML
    private void btnMasterAction(ActionEvent event) {
      setCenter("/aloe/view/manager/dashboards/master.fxml");
    }
    ...
    private void btnSalesAction(ActionEvent event) {
       service.cancel();
       setCenter("/aloe/view/manager/dashboards/sales.fxml");
    }
    ...
    private void btnChartsAction(ActionEvent event) {
         service.cancel();
        PopWindow window = new PopWindow();
        loc.push("/aloe/view/manager/dashboards.fxml");
        if (PopWindow.primaryStage.isMaximized()) {
