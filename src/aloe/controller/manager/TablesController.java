...
public class TablesController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        setCenter("/aloe/view/manager/tables/drugs.fxml");
    }    
 ...
 @FXML
    private void menuBtnDrugsAction(ActionEvent event) {
        setCenter("/aloe/view/manager/tables/drugs.fxml");
    }

    @FXML
    private void menuBtnEntriesAction(ActionEvent event) {
        setCenter("/aloe/view/manager/tables/entries.fxml");
    }

    @FXML
    private void menuBtnPacksAction(ActionEvent event) {
        setCenter("/aloe/view/manager/tables/packs.fxml");
    }
    @FXML
    private void btnExpensesAction(ActionEvent event) {
        setCenter("/aloe/view/manager/tables/expenses.fxml");
    }

    @FXML
    private void btnTransactionsAction(ActionEvent event) {
        setCenter("/aloe/view/manager/tables/transactions.fxml");
    }

    @FXML
    private void btnSalesAction(ActionEvent event) {
         setCenter("/aloe/view/manager/tables/sales.fxml");
    }
    ...
    private void btnDashboardsAction(ActionEvent event) {
            PopWindow window = new PopWindow();
        loc.push("/aloe/view/manager/tables.fxml");
        if (PopWindow.primaryStage.isMaximized()) {
