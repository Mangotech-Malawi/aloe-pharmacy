...
public class ExcelReportsController implements Initializable {
    ...
    private void generateMasterReport(String filename){
        try{
            ...
            HSSFSheet sheet = hwb.createSheet("Master Sales");
            
            HSSFRow rowhead = sheet.createRow((short)0);
            rowhead.createCell((short)0).setCellValue("Sale No");
            rowhead.createCell((short)1).setCellValue("name");
            rowhead.createCell((short)2).setCellValue("Entry/Pack");
            rowhead.createCell((short)3).setCellValue("Date");
            rowhead.createCell((short)4).setCellValue("Quantity");
            rowhead.createCell((short)5).setCellValue("Charge");
                            ...
                            if(rs3.next()){
                                ...
                                if(rs4.next()){
                                    ...
                                    if(rs5.next()){
                                        ...
                                        row.createCell((short)0).setCellValue(rs1.getString("saleNo"));
                                        row.createCell((short)1).setCellValue(name);
                                        row.createCell((short)2).setCellValue(rs1.getString("item"));
                                        row.createCell((short)3).setCellValue(regDate.getDayOfMonth() + " " 
                                               + regDate.getMonth().name() + ", " + regDate.getYear());
                                        row.createCell((short)4).setCellValue(rs1.getString("quantity"));
                                        row.createCell((short)5).setCellValue(rs1.getString("charge"));
        ...
        switch(selected){
            case "Master" : generateMasterReport(System.getProperty("user.home")  
                    + "\\Documents\\Aloe\\Sales Reports\\" 
                            + yearMasterCombo.getValue() +" My Sales Master Report.xls");break;
            case "Monthly" :  generateMonthlyReport(System.getProperty("user.home")  
                    + "\\Documents\\Aloe\\Sales Reports\\" + monthCombo.getValue() + " " 
                            + yearCombo.getValue()+" My Sales Report.xls");break;
            case "Daily" :  generateDailyReport(System.getProperty("user.home")  
                    + "\\Documents\\Aloe\\Sales Reports\\" + expenseDatePicker.getValue() + " My Sales Report.xls");break;
        } 
    }
