...
public class ViewSalesController implements Initializable {
    ...
    private void btnExcelAction(ActionEvent event) {
        ...
        window.loadSmallWindow("/aloe/view/receptionist/reports/excelReports.fxml", "", 
    ...
    private void btnPdfAction(ActionEvent event) {
        ...
        Effect effect = new GaussianBlur(4.0);
        primaryStage.getScene().getRoot().setEffect(effect);
        window.loadSmallWindow("/aloe/view/receptionist/reports/pdfReport.fxml", "", 
                true,false,false,true);
        window.getChildStage().setOnHidden(new EventHandler<WindowEvent>() {
        @Override
        public void handle(WindowEvent event) {
    ...
    private void btnWordAction(ActionEvent event) {
        ...
        Effect effect = new GaussianBlur(4.0);
        primaryStage.getScene().getRoot().setEffect(effect);
        window.loadSmallWindow("/aloe/view/receptionist/reports/wordReports.fxml", "", 
                true,false,false,true);
        window.getChildStage().setOnHidden(new EventHandler<WindowEvent>() {
        @Override
        public void handle(WindowEvent event) {
    ...
    private void btnViewLargeTableAction(ActionEvent event) {
        ...
        Effect effect = new GaussianBlur(4.0);
        primaryStage.getScene().getRoot().setEffect(effect);
        window.loadSmallWindow("/aloe/view/receptionist/transaction/viewSales.fxml", "", 
                true,true,true,true);
        window.getChildStage().setOnHidden(new EventHandler<WindowEvent>() {
            @Override
            public void handle(WindowEvent event) {
