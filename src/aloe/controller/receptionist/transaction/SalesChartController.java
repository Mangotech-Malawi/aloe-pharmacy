 ...
 * @author Senze
 */
public class SalesChartController implements Initializable {
     ...
     private void loadLineChartData(String month){
       try {  
        ...
        String transQuery = "SELECT transNo,trans_date FROM"
                + " transactions WHERE trans_by = '" + username + "';";
    ...
    private void btnVLAction(ActionEvent event) {
        ...
        window.loadSmallWindow("/aloe/view/receptionist/transaction/"
                + "salesLineChart.fxml", onView 
