...
public class MyTransactionsController implements Initializable {
    ...
    public static ObservableList<Transaction> transList = FXCollections.observableArrayList();
    @FXML
    ...
    private void loadColData(String sortType){
        ...
        String transQuery = "SELECT * from transactions where trans_by "
                + "= '" + username + "' ORDER BY transNo " + sortType + ";";
        ...
        try {
            ...
            while(rs1.next()){
                ...
                if(rs2.next()){
                    ...
                    transList.add(new Transaction(transNo,date,time,sales));
                }
            }
