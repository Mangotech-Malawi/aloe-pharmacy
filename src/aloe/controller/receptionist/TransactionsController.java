...
public class TransactionsController implements Initializable {
    ...
    @FXML
    private JFXButton btnSaleChart;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        setCenter("/aloe/view/receptionist/transaction/dashboard.fxml");
    }    
    ...
    @FXML
    private void btnTransactionsAction(ActionEvent event) {
        setCenter("/aloe/view/receptionist/transaction/myTransactions.fxml");
    }

    @FXML
    private void btnSalesAction(ActionEvent event) {
        setCenter("/aloe/view/receptionist/transaction/viewSales.fxml");
    }
    @FXML
    private void btnSaleChartAction(ActionEvent event) {
        setCenter("/aloe/view/receptionist/transaction/salesChart.fxml");
    }
    ...
    private void btnPosAction(ActionEvent event) {
        PopWindow window = new PopWindow();
        loc.push("/aloe/view/receptionist/Transactions.fxml");
        if(PopWindow.primaryStage.isMaximized()){
    ...
    private void btnSettingsAction(ActionEvent event) {
        ...
        if(PopWindow.primaryStage.isMaximized()){
              ...
              window.loadWindow("/aloe/view/receptionist/settingsfxml", "Pharmacy System : Reports",true,false,false,false);
        }
