...
public class PopWindow {
  ...
  public static  Stack<String> loc = new Stack<>();
   ...
   public  void loadWindow(String loc, String title,boolean resizable){
    ...
    public void setCenter(String location,StackPane root){
           root.getChildren().clear();
            try {
              StackPane stackPane = FXMLLoader.load(getClass().getResource(location));
              ObservableList<Node> elements = stackPane.getChildren();
              root.getChildren().setAll(elements);
              System.out.println("Zubeba");
           } catch (IOException ex) {
              System.out.println("Failed to call " + location );
           }
    }
